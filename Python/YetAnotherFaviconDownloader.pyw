...
keepassotp = plugin(
    'Yet Another Favicon Downloader', # plugin_name
    'https://raw.githubusercontent.com/navossoc/KeePass-Yet-Another-Favicon-Downloader/master/VERSION', # url
    'navossoc', # author
    'KeePass-Yet-Another-Favicon-Downloader' # repo
    )
